  ...
  return (
    <header className="w-full h-[60px] px-5 flex items-center justify-between bg-gray-800 border-b border-gray-700 box-border text-gray-200 flex-shrink-0">
      <div className="flex items-center">
        ...
        <h1 className="text-[19px] font-semibold text-gray-200 ml-3 whitespace-nowrap">Gestão Choperia</h1>
      </div>
      ...
      <div className="relative inline-block" ref={menuRef}>
        ...
        >
          ...
          <div className="flex flex-col ml-3 text-left leading-tight">
            <span className="text-[15px] font-semibold text-gray-200 whitespace-nowrap">{userName || 'Usuário'}</span>
            <span className="text-[13px] text-gray-400 whitespace-nowrap">{getRoleDisplayName(userRole)}</span>
          </div>
        </button>

        {isDropdownOpen && (
          <div className="absolute right-0 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50" id="profile-menu-id" role="menu">
